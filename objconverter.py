...
# python3 objconverter.py jammer/res/frog.obj:jammer/res/frog.png jammer/res/lilypad.obj:jammer/res/lilypad.png jammer/res/rock.obj:jammer/res/rock.png -o jammer/res/models.bin
